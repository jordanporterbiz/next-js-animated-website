      ...
      <div className="h-full overflow-scroll lg:flex" ref={containerRef}>
        ...
        <div className="p-4 sm:p-8 md:p-12 lg:p-20 xl:p-48 flex flex-col gap-24 md:gap-32 lg:gap-48 xl:gap-64 lg:w-2/3 lg:pr-0 xl:w-1/2">
          ...
          <div className="flex flex-col gap-12 justify-center">
            ...
            <p className="text-lg">
              Coder, Hiker, and Adventure Seeker.
                
              
            </p>
            <p className="text-lg">
             I&apos;m an experienced dev with a focus on full-stack development 🧑🏻‍💻 I&apos;ve always been super passionate about leveraging modern technologies to drive innovation forward 🚀
            </p>
            <p className="text-lg">
            I have a strong background in web development, with a focus on JavaScript tech stacks. A team player who leads from the front with a proven
            track record of delivering high-quality software solutions. I&apos;m always on the lookout to take on new challenges & currently 
            seeking a new side project to work on. Hit me up if you have an exciting new idea and wanna work together!
            </p>

            <p className="text-lg">
              Outside of my work, I&apos;m a big fan of getting outdoors as much as possible and exploring new places. I love hiking, camping, and traveling. If I&apos;m not coding, you&apos;ll probably find me out in the Scottish Highlands somewhere. For me, there&apos;s nothing better than getting out into nature and enjoying the great outdoors 🥾
            </p>

            <p className="text-lg">
              To follow along, check out my socials and blog content over on the Adventures page. I&apos;ll be sharing my latest projects, adventures, and more. Stay tuned! Peace ✌️
            </p>


            {/* BIOGRAPHY QUOTE */}
            <span className="italic">
            Life&apos;s too short not to pursue what matters most.
            ...
            >
              ...
              <div className="flex justify-between h-48">
                ...
                <div className="w-1/3 ">
                  ...
                  <div className="p-3 text-sm italic">
                    I led the dev team, helping to streamline the company&apos;s business processes.{" "}
                  </div>
                  {/* JOB DATE */}
              ...
              <div className="flex justify-between h-48">
                ...
                <div className="w-1/3 ">
                  ...
                  {/* JOB DESC */}
                  <div className="p-3 text-sm italic">
                    I  developed the company&apos;s new B2B solution, Zumo Enterprise.{" "}
                  </div>
                  {/* JOB DATE */}
                  <div className="p-3 text-red-400 text-sm font-semibold">
                    2021 - 2023{" "}
